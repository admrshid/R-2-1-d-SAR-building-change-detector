from model_synthetic.Video_classification_modules import Conv2Plus1D
from model_synthetic.Video_classification_modules import add_residual_block
from model_synthetic.Video_classification_modules import ResizeVideo
