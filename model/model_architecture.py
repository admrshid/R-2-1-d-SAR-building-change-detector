...
from model.Video_classification_modules import InstanceNormalization

from keras import layers
import keras

def create_model(HEIGHT,WIDTH,CHANNELS, m,frame):

    input_shape = (frame, HEIGHT, WIDTH, CHANNELS) # creates a tuple 
